---
description: Prueba por ejecucion que las barreras del proyecto muerden de verdad (regla 24 de CLAUDE.md)
---

**Regla 24 de CLAUDE.md: una barrera no verificada por ejecucion NO es una barrera.** En el proyecto anterior,
