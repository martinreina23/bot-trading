...
## Antes de escribir — test de compuerta (regla 17 de CLAUDE.md)
...
## Quien firma
Nunca el mismo agente que produjo los numeros en los que se apoya la decision (regla 15 de CLAUDE.md).
